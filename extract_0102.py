...
url = 'http://sinyoungscm.com/bbs/board.php?bo_table=0102'
...
# Replace relative URLs in a specific HTML string
...
# Write to disk
with open('f:/webpage2/sub_0102_part1.html', 'w', encoding='utf-8') as f: f.write(part1_clean)
with open('f:/webpage2/sub_0102_part2.html', 'w', encoding='utf-8') as f: f.write(part2_clean)
with open('f:/webpage2/sub_0102_part3.html', 'w', encoding='utf-8') as f: f.write(part3_clean)

combined = part1_clean + '\n' + part2_clean + '\n' + part3_clean
with open('f:/webpage2/sub_0102.html', 'w', encoding='utf-8') as f: f.write(combined)
