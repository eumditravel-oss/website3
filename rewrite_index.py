...
<title>(주)신영에스씨엠 | 안전진단 전문기관</title>
...
<section class="hero">
    <div class="container">
        <div class="hero-content fade-up">
            ...
            <p class="hero-desc">(주)신영에스씨엠은 정밀한 진단과 최첨단 장비로<br>여러분의 안전을 가장 먼저 생각합니다.</p>
...
<section class="container">
    <div class="trust-metrics fade-up">
        <div class="metric-card">
            ...
            <div class="metric-number"><span class="count-up" data-target="100">0</span>%</div>
            <div class="metric-label">정부공인 안전기관</div>
        </div>
        <div class="metric-card">
            <div class="metric-icon"><i class="fas fa-hard-hat"></i></div>
            <div class="metric-number"><span class="count-up" data-target="25">0</span>년</div>
            <div class="metric-label">축적된 전문 업력</div>
        </div>
        <div class="metric-card">
            <div class="metric-icon"><i class="fas fa-building-circle-check"></i></div>
            <div class="metric-number"><span class="count-up" data-target="3000">0</span>+</div>
            <div class="metric-label">성공적인 진단 실적</div>
        </div>
        <div class="metric-card">
            <div class="metric-icon"><i class="fas fa-microscope"></i></div>
            <div class="metric-number"><span class="count-up" data-target="50">0</span>+</div>
            <div class="metric-label">최첨단 장비 보유</div>
        </div>
    </div>
</section>
    ...
    <div class="container fade-up">
        <div class="news-grid">
            <div class="news-box">
                ...
                <ul class="news-list">
                    <li><a href="./sub_0401.html"><span>안녕하세요. (주)신영에스씨엠입니다.</span> <span class="news-date">06-05</span></a></li>
