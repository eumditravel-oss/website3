...
<section class="container">
    <div class="trust-metrics fade-up">
        <div class="metric-card">
            ...
            <div class="metric-number"><span>2022.12</span></div>
            <div class="metric-label">법인 설립</div>
        </div>
        <div class="metric-card">
            <div class="metric-icon"><i class="fas fa-certificate"></i></div>
            <div class="metric-number"><span class="count-up" data-target="3">0</span>종</div>
            <div class="metric-label">전문 등록</div>
        </div>
        <div class="metric-card">
            <div class="metric-icon"><i class="fas fa-briefcase"></i></div>
            <div class="metric-number"><span class="count-up" data-target="6">0</span>개</div>
            <div class="metric-label">주요 업무</div>
        </div>
        <div class="metric-card">
            <div class="metric-icon"><i class="fas fa-microscope"></i></div>
            <div class="metric-number"><span class="count-up" data-target="17">0</span>종</div>
            <div class="metric-label">보유 장비</div>
        </div>
    </div>
</section>
