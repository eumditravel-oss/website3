...
url = 'http://sinyoungscm.com/bbs/board.php?bo_table=0103'
...
# Write to disk
with open('f:/webpage2/sub_0103_part1.html', 'w', encoding='utf-8') as f: f.write(part1_clean)
with open('f:/webpage2/sub_0103_part2.html', 'w', encoding='utf-8') as f: f.write(part2_clean)
with open('f:/webpage2/sub_0103_part3.html', 'w', encoding='utf-8') as f: f.write(part3_clean)

combined = part1_clean + '\n' + part2_clean + '\n' + part3_clean
with open('f:/webpage2/sub_0103.html', 'w', encoding='utf-8') as f: f.write(combined)
